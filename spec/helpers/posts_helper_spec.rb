...
RSpec.describe PostsHelper, type: :helper do
  # pending "add some examples to (or delete) #{__FILE__}"
	context "#create_new_post_partial_path" do
	  	it "return a signed_in partial's path" do 
	...
	context "#all_categories_button_partial_path" do
		it "return an all_selected partial's path" do
	...
	context "#no_posts_partial_path" do
		it "return a no_posts partial's path" do
			assign(:posts, [])
			expect(helper.no_post_partial_path).to (
